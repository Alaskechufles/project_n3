...
<body>
    <main class="h-screen bg-[#C6D2D2] flex flex-row">
        ...
        <div class="w-full">
            ...
            <div class="bg-white p-4 w-[700px] m-5 rounded-xl shadow-lg text-[#8FA5BD]">
                <table class=" table-auto w-full">
                    ...
                    <tbody>
                        <tr class=" text-center border-b  border-[#2c7fd2]">
                            <td class=" w-1/4">1</td>
                            <td class=" w-1/4">admin@admin</td>
                            <td class=" w-1/4">Administrador</td>
                            <td class=" w-full h-[30px] flex justify-center items-center">
                                <button class=" cursor-pointer text-[#4A93A1] flex justify-center items-center">
            ...
            <tr class=" text-center border-b  border-[#2c7fd2]">
                <td class=" w-1/4">2</td>
                <td class=" w-1/4">maestro@maestro</td>
                <td class=" w-1/4">Maestro</td>
                <td class=" w-full h-[30px] flex justify-center items-center">
                    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class=" text-[#4A93A1] flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                        </svg>
                        ...
                        <div class="relative w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="px-6 py-6 lg:px-8">
                                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Editar Permiso
                                    </h3>
                                    <form class="space-y-6" action="#">
                                        ...
                                        <div>
                                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rol
                                                del usuario</label>
                                        ...
                                        <div>
                                            <button type="button" class="w-[100px] text-white bg-[#6C747E] hover:text-[#6C747E] hover:bg-gray-200 px-5 py-2.5 rounded-lg text-sm ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal">Close
                                            </button>
