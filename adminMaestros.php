                    ...
                    <tbody>
                        ...
                        <tr class=" text-center border-b  border-[#2c7fd2]">
                            ...
                            <td class=" w-full h-[30px] flex justify-center items-center gap-5">
                                <button data-modal-target="authentication-modal<?= $id ?>b"
                                    data-modal-toggle="authentication-modal<?= $id ?>b"
                                ...
                                <form action="adminMaestrosDelete.php" method="post">
                                    <button type="submit" class=" text-red-600" name="eliminar" id="eliminar"
                                        value="<?= $id ?>">
                                ...
                                <!-- Main modal -->
                                <div id="authentication-modal<?= $id ?>b" tabindex="-1" aria-hidden="true"
                                    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative w-full max-w-md max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <button type="button"
                                                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-hide="authentication-modal<?= $id ?>b">
                                            ...
                                            <div class="px-6 py-6 lg:px-8">
                                                ...
                                                <form class="space-y-6" action="adminMaestrosEdit.php" method="post">
                                                    ...
                                                    <div>
                                                        <button type="button"
                                                            class="w-[100px] text-white bg-[#6C747E] hover:text-[#6C747E] hover:bg-gray-200 px-5 py-2.5 rounded-lg text-sm ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                            data-modal-hide="authentication-modal<?= $id ?>b">Close
                                                        </button>
