...
<body>
    <main class="bg-gradient-to-r from-blue-300 to-blue-800 h-screen flex justify-center items-center">
        <div class="w-[400px] bg-[#FBF4D3] rounded-3xl overflow-hidden flex flex-col">
            ...
            <form action="loginVerificacion.php" class="flex flex-col p-4 gap-4 justify-center items-center"
                method="post">
                ...
                <div class="w-[90%] flex flex-row items-center bg-white px-4 py-2 border border-[#7A7678] rounded-xl">
                    <input name="correo" type="text" class="w-full outline-none border-none shadow-none"
                        placeholder="Email" />

                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style="fill: rgba(122, 118, 120, 1); transform: msFilter">
                        <path
                ...
                <div class="w-[90%] flex flex-row items-center bg-white px-4 py-2 border border-[#7A7678] rounded-xl">
                    <input name="contra" type="text" class="w-full outline-none border-none" placeholder="Password" />
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        style="fill: rgba(122, 118, 120, 1); transform: msFilter">
                        <path
