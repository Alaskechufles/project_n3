...
<body>
  <main class="bg-[#2164A7] h-screen flex justify-center items-center">
    <div class="w-[400px] bg-[#FBF4D3] rounded-3xl overflow-hidden flex flex-col">
      ...
      <form action="" class="flex flex-col p-4 gap-4 justify-center items-center">
        <p>Bienvenido ingresa con tu cuenta</p>
        <div class="w-[90%] flex flex-row bg-white px-4 py-2 border border-[#7A7678] rounded-xl">
          <input type="text" class="w-full outline-none" placeholder="Email" />
        ...
        <div class="w-[90%] flex flex-row bg-white px-4 py-2 border border-[#7A7678] rounded-xl">
          <input type="text" class="w-full outline-none" placeholder="Password" />
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(122, 118, 120, 1); transform: msFilter">
