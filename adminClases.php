                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" action="adminClasesCreate.php" method="post">
                                    <div class=" flex flex-col gap-3">
                                        <label for="clase_nueva" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                            Nombre de la Materia</label>
                                        <input type="text" name="clase_nueva" id="clase_nueva" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ingresa la materia" required>

                                    </div>
                                    <div>
                                        <label for="maestro" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maestros
                                            disponibles para la clase
                                        </label>
                                        <select name="maestro" id="maestro" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                        ...
                        ?>
                            <tr class=" text-center border-b  border-[#2c7fd2]">
                                ...
                                <td class=" w-full h-[30px] flex justify-center items-center gap-5">
                                    <button data-modal-target="authentication-modal<?= $id ?>a" data-modal-toggle="authentication-modal<?= $id ?>a" class=" text-[#4A93A1] flex justify-center items-center">
                                    ...
                                    <!-- Main modal -->
                                    <div id="authentication-modal<?= $id ?>a" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative w-full max-w-md max-h-full">
                                            <!-- Modal content -->
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal<?= $id ?>a">
                                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                    </svg>
                                                    <span class="sr-only">Close modal</span>
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    ...
                                                    <form class="space-y-6" action="adminClasesEdit.php" method="post">
                                                        <div>
                                                            <label for="clase_edit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                                Nombre de la Materia</label>
                                                            <input type="text" name="clase_edit" id="clase_edit" value="<?= $curso ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ingresa clase" required>

                                                        </div>
                                                        <div>
                                                            <label for="maestro_edit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maestro
                                                                Asignada</label>
                                                            <select id="maestro_edit" name="maestro_edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                                        ...
                                                        <div>
                                                            <button type="button" class="w-[100px] text-white bg-[#6C747E] hover:text-[#6C747E] hover:bg-gray-200 px-5 py-2.5 rounded-lg text-sm ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal<?= $id ?>a">Close
                                                            </button>
                                                            <button type="submit" value="<?= $id ?>" name="id_curso" class="w-[150px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar
                                                                cambios</button>
                                                        </div>
                                                    </form>
                                                </div>
