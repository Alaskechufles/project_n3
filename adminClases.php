                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    ...
                                                    <form class="space-y-6" action="adminClasesEdit.php" method="post">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button type="submit" value="<?= $id ?>" class="w-[150px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar
                                                                cambios</button>
                                                        </div>
                                                    </form>
                                                </div>
