                ...
                <table class=" table-auto w-full">
                    <thead>
                        <tr class=" text-center border-b  border-[#2c7fd2]">
                            <th class=" w-1/8">#</th>
                            <th class=" w-1/4">Clase</th>
                            <th class=" w-1/4">Maestro</th>
                            <th class=" w-1/4">Alumnos inscritos</th>
                            <th class=" w-1/8">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class=" text-center border-b  border-[#2c7fd2]">
                            <td class=" w-1/8">1</td>
                            <td class=" w-1/4">Programación</td>
                            <td class=" w-1/4">Harold Zuñiga</td>
                            <td class=" w-1/4">17</td>
